...
class PIIFormatter(BaseFormatter):
    ...
    def __init__(
        ...
        priority_order = pd.Categorical(df['Priority'], categories=self.priorities_to_keep, ordered=True)
        ...
        for _, row in df.iterrows():
            ...
            if priority in self.priorities_to_keep:
                ...
                replacement = row['Replacement'] if 'Replacement' in row else "[REDACTED]"
